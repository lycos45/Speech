...
def main():
    ...
    language = st.selectbox("Sélectionnez la Langue pour la Transcription", ["fr-FR", "en-US"])
    
    # Sélection de la langue cible pour la traduction
    dest_language = st.selectbox("Sélectionnez la Langue de Traduction", ["en", "fr", "es", "de"])
